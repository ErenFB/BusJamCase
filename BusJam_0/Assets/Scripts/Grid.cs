...
public class Grid<TGridObject> {
    ...
    public Vector3 GetWorldPositionReal(int x, int y)
    {
        originPosition=new Vector3(5,0,5);
    ...
    public void GetXY(Vector3 worldPosition, out int x, out int y) {
        ...
        y = Mathf.FloorToInt((worldPosition - originPosition).z / cellSize); //Debug.LogError("GETXYxy" + x + y);
    }
